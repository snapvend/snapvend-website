...
DEMO_SECTION = {
    ...
    "it": {
        ...
        "steps": [
            {"title": "Importa le foto", "body": "Selezionale dalla galleria locale oppure trasferiscile direttamente nell'app da una fotocamera professionale con supporto FTP."},
...
PROOF_SECTION = {
    ...
    "it": {
        ...
        "references": [
            ...
            {"title": "Operazioni su rete locale", "body": "Pensato per team che preferiscono hotspot o rete locale invece di dipendere da internet."},
    ...
    "hi": {
        ...
        "references": [
            ...
            {"title": "लोकल नेटवर्क टीमें", "body": "हॉटस्पॉट या लोकल नेटवर्क पर काम करने वाली टीमों के लिए बनाया गया है।"},
...
CONTACT_SECTION = {
    ...
    "it": {
        ...
        "lead": "Quando invii il modulo, si apre l'app email predefinita e il messaggio viene preparato per snapvendinfo@gmail.com.",
        ...
        "submit": "Invia",
        "direct_email": "Invia Email Direttamente",
        "disclaimer": "Il pulsante apre la tua app email così puoi controllare e confermare il messaggio.",
...
COPY = {
    ...
    "it": {
        ...
        "audience_cards": [
            ...
            {"title": "Scuola, sport e lavori corporate", "body": "Team che gestiscono molte sessioni senza confondere clienti o consegne."},
            {"title": "Street photography, aree turistiche e ritratti mobili", "body": "Un flusso solido per fotografi che vogliono scattare sul posto, mostrare subito le immagini selezionate e vendere singole foto o pacchetti."},
            {"title": "Team di consegna mobile", "body": "Operazioni che lavorano su rete locale o hotspot senza dipendere da internet."},
        ],
        "pricing_eyebrow": "Piani",
        "pricing_title": "Inizia gratis e cresci con Pro",
        "pricing_lead": "Il piano gratuito è pronto per imparare il flusso. Pro rimuove i limiti di consegna e sblocca il branding aziendale.",
        ...
        "monthly_cta": "Scarica l'app",
        "yearly_badge": "Pro Annuale",
    ...
    "hi": {
        ...
        "workflow_cards": [
            ...
            {"title": "लोकल भुगतान दिखाएँ", "body": "बिज़नेस देश के हिसाब से payment popup में FAST / EFT, Bizum, UPI, Alipay, WeChat Pay या PayPay जैसे तैयार तरीके दिखाएँ।"},
        ...
        "pricing_title": "मुफ़्त से शुरू करें और Pro के साथ बढ़ें",
        "pricing_lead": "मुफ़्त प्लान फ्लो सीखने के लिए तैयार है। Pro सीमा हटाता है और बिज़नेस ब्रांडिंग खोलता है।",
...
COPY_FLOW_OVERRIDES = {
    ...
    "it": {
        "hero_lead": "Importa le foto dalla galleria locale oppure trasferiscile direttamente nell'app da una fotocamera professionale con FTP, apri una sessione separata per ogni servizio, fai entrare il cliente tramite QR e consegna i file approvati in ZIP dallo stesso dispositivo.",
        "metrics": [
        ...
        "workflow_cards": [
            ...
            {"title": "Consegna ZIP e monitora i report", "body": "Consegna i file approvati in ZIP e tieni sotto controllo consegne e ricavi per sessione direttamente nell'app."},
        ],
    },
    "pt": {
...
FAQ_FLOW_OVERRIDES = {
    ...
    "it": [
        {"q": "SnapVend funziona senza internet?", "a": "Sì. Il flusso principale può funzionare su rete locale o hotspot senza dipendere dal cloud."},
        {"q": "Posso trasferire direttamente da una fotocamera professionale?", "a": "Sì. Le foto possono entrare direttamente in SnapVend da una fotocamera professionale compatibile con FTP sulla stessa rete o hotspot."},
        ...
        {"q": "Posso usare il mio nome e il mio logo?", "a": "Sì. I piani Pro sbloccano branding personalizzato, logo e consegna brandizzata."},
