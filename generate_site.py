...
PRIVACY_POLICY_URL = f"{SITE_URL}/privacy-policy/"
...
PRICING_FEATURE_EXPANSION = {
    "tr": {
        "monthly": [
            "Sınırsız günlük teslim",
            "Sınırsız canlı sunum ve büyük ekran satış vitrini",
            "Sınırsız baskı kuyruğu / baskı sipariş listesi",
            "Detaylı satış, indirme ve dönüşüm raporları",
            "Ödeme/PAC onayı ve ZIP teslim akışı",
            "1 telefon + 1 tablet aktivasyonu",
            "Özel işletme adı, logo ve ZIP dosya adı",
            "Satın alma geri yükleme ve abonelik yönetimi",
        ],
        "yearly": [
            "Aylık Premium’daki tüm operasyon özellikleri",
            "12 aylık kullanımda daha avantajlı toplam maliyet",
            "Doğrulanmış lisansla 14 gün offline erişim penceresi",
            "Yoğun düğün, etkinlik ve saha ekipleri için sürdürülebilir kullanım",
            "Canlı sunum, baskı kuyruğu ve raporları yıl boyu limitsiz kullanma",
            "Marka ve teslim akışı üzerinde tam kontrol",
        ],
        "note": "Premium; sınırsız teslim, canlı sunum, baskı kuyruğu, detaylı raporlar, ödeme/PAC onayı, markalı ZIP teslimi ve 1 telefon + 1 tablet aktivasyonunu tek lisans altında toplar. Yıllık Premium aynı operasyon haklarını daha avantajlı yıllık maliyetle sunar.",
        "faq": {"q": "Premium planda hangi operasyon özellikleri açılır?", "a": "Premium plan; sınırsız günlük teslim, canlı sunum, baskı kuyruğu, detaylı raporlar, ödeme/PAC onayı, markalı ZIP teslimi, 1 telefon + 1 tablet aktivasyonu, satın alma geri yükleme ve abonelik yönetimini açar."},
    },
    "en": {
        "monthly": [
            "Unlimited daily deliveries",
            "Unlimited live presentations and big-screen sales display",
            "Unlimited print queue / print order list",
            "Detailed sales, download and conversion reports",
            "Payment/PAC approval and ZIP delivery flow",
            "1 phone + 1 tablet activation",
            "Custom business name, logo and ZIP filename",
            "Purchase restore and subscription management",
        ],
        "yearly": [
            "All monthly Premium operational features",
            "Better total cost across 12 months",
            "14-day offline access window for verified licenses",
            "Sustainable use for busy wedding, event and field teams",
            "Year-round unlimited live presentation, print queue and reports",
            "Full control over branding and delivery flow",
        ],
        "note": "Premium brings unlimited delivery, live presentation, print queue, detailed reports, payment/PAC approval, branded ZIP delivery and 1 phone + 1 tablet activation under one license. Yearly Premium keeps the same operational rights with better annual cost.",
        "faq": {"q": "Which operational features does Premium unlock?", "a": "Premium unlocks unlimited daily delivery, live presentation, print queue, detailed reports, payment/PAC approval, branded ZIP delivery, 1 phone + 1 tablet activation, purchase restore and subscription management."},
    },
    "es": {
        "monthly": [
            "Entregas diarias ilimitadas",
            "Presentaciones en vivo ilimitadas y vitrina de venta en pantalla grande",
            "Cola de impresion / lista de pedidos ilimitada",
            "Reportes detallados de ventas, descargas y conversion",
            "Aprobacion de pago/PAC y entrega ZIP",
            "Activacion de 1 telefono + 1 tablet",
            "Nombre comercial, logo y nombre ZIP personalizados",
            "Restauracion de compra y gestion de suscripcion",
        ],
        "yearly": [
            "Todas las funciones operativas del Premium mensual",
            "Mejor coste total en 12 meses",
            "Ventana offline de 14 dias para licencias verificadas",
            "Uso sostenible para bodas, eventos y equipos de campo intensivos",
            "Presentacion en vivo, cola de impresion y reportes ilimitados todo el ano",
            "Control total de marca y flujo de entrega",
        ],
        "note": "Premium reune entrega ilimitada, presentacion en vivo, cola de impresion, reportes detallados, aprobacion de pago/PAC, entrega ZIP con marca y activacion de 1 telefono + 1 tablet. Premium anual mantiene los mismos derechos con mejor coste anual.",
        "faq": {"q": "¿Que funciones operativas abre Premium?", "a": "Premium abre entrega diaria ilimitada, presentacion en vivo, cola de impresion, reportes detallados, aprobacion de pago/PAC, entrega ZIP con marca, activacion de 1 telefono + 1 tablet, restauracion de compra y gestion de suscripcion."},
    },
    "fr": {
        "monthly": [
            "Livraisons quotidiennes illimitees",
            "Presentations en direct illimitees et vitrine de vente grand ecran",
            "File d'impression / liste de commandes illimitee",
            "Rapports detailles ventes, telechargements et conversion",
            "Validation paiement/PAC et livraison ZIP",
            "Activation de 1 telephone + 1 tablette",
            "Nom d'entreprise, logo et nom ZIP personnalises",
            "Restauration d'achat et gestion d'abonnement",
        ],
        "yearly": [
            "Toutes les fonctions operationnelles du Premium mensuel",
            "Meilleur cout total sur 12 mois",
            "Fenetre offline de 14 jours pour licence verifiee",
            "Usage durable pour mariages, evenements et equipes terrain intenses",
            "Presentation live, file d'impression et rapports illimites toute l'annee",
            "Controle complet de la marque et du flux de livraison",
        ],
        "note": "Premium regroupe livraison illimitee, presentation en direct, file d'impression, rapports detailles, validation paiement/PAC, livraison ZIP marquee et activation 1 telephone + 1 tablette. Premium annuel garde les memes droits avec un meilleur cout annuel.",
        "faq": {"q": "Quelles fonctions operationnelles Premium debloque-t-il ?", "a": "Premium debloque livraison quotidienne illimitee, presentation en direct, file d'impression, rapports detailles, validation paiement/PAC, livraison ZIP marquee, activation 1 telephone + 1 tablette, restauration d'achat et gestion d'abonnement."},
    },
    "de": {
        "monthly": [
            "Unbegrenzte taegliche Auslieferungen",
            "Unbegrenzte Live-Praesentationen und Grossbild-Verkaufsanzeige",
            "Unbegrenzte Druckwarteschlange / Druckbestellliste",
            "Detaillierte Verkaufs-, Download- und Conversion-Berichte",
            "Zahlungs-/PAC-Freigabe und ZIP-Auslieferung",
            "Aktivierung fur 1 Telefon + 1 Tablet",
            "Eigener Firmenname, Logo und ZIP-Dateiname",
            "Kaufwiederherstellung und Abo-Verwaltung",
        ],
        "yearly": [
            "Alle operativen Funktionen von Premium monatlich",
            "Bessere Gesamtkosten uber 12 Monate",
            "14 Tage Offline-Fenster fur verifizierte Lizenzen",
            "Dauerhafte Nutzung fur intensive Hochzeits-, Event- und Einsatzteams",
            "Live-Praesentation, Druckwarteschlange und Berichte ganzjaehrig unbegrenzt",
            "Volle Kontrolle uber Branding und Lieferablauf",
        ],
        "note": "Premium bundelt unbegrenzte Lieferung, Live-Praesentation, Druckwarteschlange, detaillierte Berichte, Zahlungs-/PAC-Freigabe, gebrandete ZIP-Lieferung und Aktivierung fur 1 Telefon + 1 Tablet. Premium jaehrlich bietet dieselben Rechte mit besseren Jahreskosten.",
        "faq": {"q": "Welche operativen Funktionen schaltet Premium frei?", "a": "Premium schaltet unbegrenzte taegliche Lieferung, Live-Praesentation, Druckwarteschlange, detaillierte Berichte, Zahlungs-/PAC-Freigabe, gebrandete ZIP-Lieferung, Aktivierung fur 1 Telefon + 1 Tablet, Kaufwiederherstellung und Abo-Verwaltung frei."},
    },
    "it": {
        "monthly": [
            "Consegne giornaliere illimitate",
            "Presentazioni live illimitate e vetrina vendita su grande schermo",
            "Coda stampa / lista ordini stampa illimitata",
            "Report dettagliati su vendite, download e conversioni",
            "Approvazione pagamento/PAC e consegna ZIP",
            "Attivazione di 1 telefono + 1 tablet",
            "Nome azienda, logo e nome ZIP personalizzati",
            "Ripristino acquisto e gestione abbonamento",
        ],
        "yearly": [
            "Tutte le funzioni operative del Premium mensile",
            "Costo totale migliore su 12 mesi",
            "Finestra offline di 14 giorni per licenze verificate",
            "Uso sostenibile per matrimoni, eventi e team sul campo intensivi",
            "Presentazione live, coda stampa e report illimitati tutto l'anno",
            "Pieno controllo di branding e consegna",
        ],
        "note": "Premium unisce consegna illimitata, presentazione live, coda stampa, report dettagliati, approvazione pagamento/PAC, consegna ZIP brandizzata e attivazione 1 telefono + 1 tablet. Premium annuale mantiene gli stessi diritti con costo annuale migliore.",
        "faq": {"q": "Quali funzioni operative sblocca Premium?", "a": "Premium sblocca consegna giornaliera illimitata, presentazione live, coda stampa, report dettagliati, approvazione pagamento/PAC, consegna ZIP brandizzata, attivazione 1 telefono + 1 tablet, ripristino acquisto e gestione abbonamento."},
    },
    "pt": {
        "monthly": [
            "Entregas diarias ilimitadas",
            "Apresentacoes ao vivo ilimitadas e vitrine de venda em tela grande",
            "Fila de impressao / lista de pedidos ilimitada",
            "Relatorios detalhados de vendas, downloads e conversao",
            "Aprovacao de pagamento/PAC e entrega ZIP",
            "Ativacao de 1 telefone + 1 tablet",
            "Nome comercial, logo e nome ZIP personalizados",
            "Restauracao de compra e gestao de assinatura",
        ],
        "yearly": [
            "Todos os recursos operacionais do Premium mensal",
            "Melhor custo total em 12 meses",
            "Janela offline de 14 dias para licencas verificadas",
            "Uso sustentavel para casamentos, eventos e equipes de campo intensas",
            "Apresentacao ao vivo, fila de impressao e relatorios ilimitados o ano todo",
            "Controle total de marca e fluxo de entrega",
        ],
        "note": "Premium reúne entrega ilimitada, apresentacao ao vivo, fila de impressao, relatorios detalhados, aprovacao de pagamento/PAC, entrega ZIP com marca e ativacao de 1 telefone + 1 tablet. Premium anual mantem os mesmos direitos com melhor custo anual.",
        "faq": {"q": "Quais recursos operacionais o Premium libera?", "a": "Premium libera entrega diaria ilimitada, apresentacao ao vivo, fila de impressao, relatorios detalhados, aprovacao de pagamento/PAC, entrega ZIP com marca, ativacao de 1 telefone + 1 tablet, restauracao de compra e gestao de assinatura."},
    },
    "ru": {
        "monthly": [
            "Неограниченные ежедневные выдачи",
            "Неограниченные живые презентации и витрина продаж на большом экране",
            "Неограниченная очередь печати / список заказов",
            "Подробные отчеты по продажам, загрузкам и конверсии",
            "Подтверждение оплаты/PAC и ZIP-выдача",
            "Активация 1 телефона + 1 планшета",
            "Свой бренд, логотип и имя ZIP файла",
            "Восстановление покупки и управление подпиской",
        ],
        "yearly": [
            "Все операционные функции месячного Premium",
            "Более выгодная стоимость за 12 месяцев",
            "14-дневное offline-окно для проверенной лицензии",
            "Устойчивое решение для свадеб, мероприятий и интенсивной выездной работы",
            "Живая презентация, очередь печати и отчеты без лимитов круглый год",
            "Полный контроль бренда и процесса выдачи",
        ],
        "note": "Premium объединяет неограниченную выдачу, живую презентацию, очередь печати, подробные отчеты, подтверждение оплаты/PAC, брендированную ZIP-выдачу и активацию 1 телефона + 1 планшета. Годовой Premium дает те же права с более выгодной годовой стоимостью.",
        "faq": {"q": "Какие операционные функции открывает Premium?", "a": "Premium открывает неограниченную ежедневную выдачу, живую презентацию, очередь печати, подробные отчеты, подтверждение оплаты/PAC, брендированную ZIP-выдачу, активацию 1 телефона + 1 планшета, восстановление покупки и управление подпиской."},
    },
    "ar": {
        "monthly": [
            "تسليم يومي غير محدود",
            "عروض مباشرة غير محدودة وشاشة بيع كبيرة",
            "قائمة انتظار الطباعة / قائمة طلبات غير محدودة",
            "تقارير مفصلة للمبيعات والتنزيلات والتحويل",
            "اعتماد الدفع/PAC وتدفق تسليم ZIP",
            "تفعيل هاتف واحد + جهاز لوحي واحد",
            "اسم تجاري وشعار واسم ملف ZIP مخصص",
            "استعادة الشراء وادارة الاشتراك",
        ],
        "yearly": [
            "كل ميزات التشغيل في Premium الشهري",
            "تكلفة اجمالية افضل خلال 12 شهرا",
            "نافذة offline لمدة 14 يوما للترخيص الموثق",
            "استخدام مستدام للاعراس والفعاليات وفرق الميدان المكثفة",
            "عرض مباشر وقائمة طباعة وتقارير غير محدودة طوال العام",
            "تحكم كامل بالعلامة وتدفق التسليم",
        ],
        "note": "يجمع Premium التسليم غير المحدود والعرض المباشر وقائمة انتظار الطباعة والتقارير المفصلة واعتماد الدفع/PAC وتسليم ZIP بالعلامة وتفعيل هاتف واحد + جهاز لوحي واحد. يوفر Premium السنوي نفس الحقوق بتكلفة سنوية افضل.",
        "faq": {"q": "ما الميزات التشغيلية التي يفتحها Premium؟", "a": "يفتح Premium التسليم اليومي غير المحدود، العرض المباشر، قائمة انتظار الطباعة، التقارير المفصلة، اعتماد الدفع/PAC، تسليم ZIP بالعلامة، تفعيل هاتف واحد + جهاز لوحي واحد، استعادة الشراء وادارة الاشتراك."},
    },
    "hi": {
        "monthly": [
            "असीमित दैनिक डिलीवरी",
            "असीमित लाइव प्रस्तुति और बड़े स्क्रीन की बिक्री विंडो",
            "असीमित प्रिंट क्यू / प्रिंट ऑर्डर सूची",
            "विस्तृत बिक्री, डाउनलोड और कन्वर्ज़न रिपोर्ट",
            "भुगतान/PAC स्वीकृति और ZIP डिलीवरी फ्लो",
            "1 फोन + 1 टैबलेट सक्रियण",
            "कस्टम व्यवसाय नाम, लोगो और ZIP फ़ाइल नाम",
            "खरीदारी पुनर्स्थापना और सदस्यता प्रबंधन",
        ],
        "yearly": [
            "मासिक Premium की सभी संचालन सुविधाएं",
            "12 महीने में बेहतर कुल लागत",
            "सत्यापित लाइसेंस के लिए 14 दिन की ऑफलाइन प्रवेश अवधि",
            "व्यस्त शादी, इवेंट और मैदानी टीमों के लिए टिकाऊ उपयोग",
            "पूरे साल लाइव प्रस्तुति, प्रिंट क्यू और रिपोर्ट असीमित",
            "ब्रांड और डिलीवरी प्रवाह पर पूरा नियंत्रण",
        ],
        "note": "Premium असीमित डिलीवरी, लाइव प्रस्तुति, प्रिंट क्यू, विस्तृत रिपोर्ट, भुगतान/PAC स्वीकृति, ब्रांडेड ZIP डिलीवरी और 1 फोन + 1 टैबलेट सक्रियण को एक लाइसेंस में जोड़ता है। वार्षिक Premium वही अधिकार बेहतर वार्षिक लागत के साथ देता है।",
        "faq": {"q": "Premium कौन-सी संचालन सुविधाएं खोलता है?", "a": "Premium असीमित दैनिक डिलीवरी, लाइव प्रस्तुति, प्रिंट क्यू, विस्तृत रिपोर्ट, भुगतान/PAC स्वीकृति, ब्रांडेड ZIP डिलीवरी, 1 फोन + 1 टैबलेट सक्रियण, खरीदारी पुनर्स्थापना और सदस्यता प्रबंधन खोलता है।"},
    },
    "ja": {
        "monthly": [
            "日次納品が無制限",
            "ライブ表示と大型画面の販売ビューが無制限",
            "プリントキュー / プリント注文リストが無制限",
            "売上、ダウンロード、コンバージョンの詳細レポート",
            "決済/PAC 承認と ZIP 納品フロー",
            "1台のスマートフォン + 1台のタブレットを有効化",
            "独自の事業名、ロゴ、ZIP ファイル名",
            "購入の復元とサブスクリプション管理",
        ],
        "yearly": [
            "月額 Premium のすべての運用機能",
            "12か月利用で総コストを最適化",
            "確認済みライセンスは14日間のオフラインアクセス枠を保持",
            "忙しいウェディング、イベント、現場チーム向けの安定利用",
            "ライブ表示、プリントキュー、レポートを年間を通じて無制限",
            "ブランドと納品フローを完全に管理",
        ],
        "note": "Premium は、無制限の納品、ライブ表示、プリントキュー、詳細レポート、決済/PAC 承認、ブランド付き ZIP 納品、1台のスマートフォン + 1台のタブレット有効化を1つのライセンスにまとめます。年額 Premium は同じ運用権限をより良い年間コストで提供します。",
        "faq": {"q": "Premium で利用できる運用機能は？", "a": "Premium は、日次納品無制限、ライブ表示、プリントキュー、詳細レポート、決済/PAC 承認、ブランド付き ZIP 納品、1台のスマートフォン + 1台のタブレット有効化、購入の復元、サブスクリプション管理を利用可能にします。"},
    },
    "zh": {
        "monthly": [
            "无限每日交付",
        ...
        "note": "Premium 将无限交付、现场展示、打印队列、详细报表、支付/PAC 确认、品牌化 ZIP 交付和 1 部手机 + 1 台平板激活整合在一个授权中。年度 Premium 以更优年度成本保留相同运营权益。",
        "faq": {"q": "Premium 会解锁哪些运营功能？", "a": "Premium 会解锁无限每日交付、现场展示、打印队列、详细报表、支付/PAC 确认、品牌化 ZIP 交付、1 部手机 + 1 台平板激活、购买恢复与订阅管理。"},
    },
}

for locale_code, values in PRICING_FEATURE_EXPANSION.items():
    COPY[locale_code]["monthly_features"] = values["monthly"]
    COPY[locale_code]["yearly_features"] = values["yearly"]
    COPY[locale_code]["pricing_license_note"] = values["note"]
    previous_license_question = PLAN_LICENSE_RULE_OVERRIDES[locale_code]["faq"]["q"]
    for faq_item in FAQ_SECTION[locale_code]["items"]:
        if faq_item["q"] == previous_license_question:
            faq_item.update(values["faq"])
            break
...
{store_badges(locale_code, copy)}
    ...
    <footer class="footer">
      <div class="container footer-inner">
        ...
        <p><a href="{prefix}/privacy-policy/">Privacy Policy / Gizlilik Politikası</a></p>
        <p>© 2026 SnapVend</p>
      </div>
    </footer>
  </body>
  ...
  <body class="download-redirect-page">
    <main class="download-redirect-shell">
      <article class="download-redirect-card">
        ...
        <a class="action-link action-link-secondary" href="../privacy-policy/">Privacy Policy</a>
      </article>
    </main>
    <script>
      (() => {{
...
def render_privacy_policy_page() -> str:
    return f"""<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>SnapVend Gallery Privacy Policy</title>
    <meta name="description" content="Privacy policy for the SnapVend Gallery mobile application and website.">
    ...
    <style>
      .privacy-page {{
        ...
        background:
          radial-gradient(circle at top left, rgba(42, 114, 255, .22), transparent 34rem),
          #061431;
      }}
      .privacy-card {{
        width: min(920px, 100%);
  ...
  <body>
    <main class="privacy-page">
      <article class="privacy-card">
        <a class="privacy-brand" href="../" aria-label="Back to SnapVend Gallery">
          <img src="../assets/branding/snapvend_logo_square_web.png" alt="" width="52" height="52">
          <strong>SnapVend Gallery</strong>
        </a>

        <p class="eyebrow">Privacy Policy</p>
        <h1>SnapVend Gallery Privacy Policy</h1>
        <p class="privacy-meta">Effective date and last updated: July 24, 2026</p>

        <p>
          This policy explains how SnapVend Gallery processes information when you use the
          SnapVend Gallery mobile application, its Premium licensing features, and the
          snapvendgallery.com website. SnapVend Gallery is provided by Metehan Eyicalis
          (“SnapVend”, “we”, “us”).
        </p>

        <div class="privacy-notice">
          <p>
            SnapVend does not upload your event photos, videos, customer galleries, local
            sales records, or print queues to the SnapVend licensing server. Those materials
            remain on your device and are shared only through local workflows you start.
          </p>
        </div>

        <h2>1. Information processed for Premium licensing</h2>
        <p>When you verify, restore, or use a Premium subscription, we process:</p>
        <ul>
          <li>
            A randomly generated, pseudonymous device identifier; general device class
            (phone or tablet); platform; and application version/build.
          </li>
          <li>
            Subscription product identifier, App Store or Google Play purchase token or
            transaction reference, validation status, plan, expiry date, and cancellation
            or revocation status.
          </li>
          <li>
            License activation records, including the active phone/tablet slots and the
            last validation time.
          </li>
        </ul>
        <p>
          We do not receive or store your payment card number or bank account details.
          Payments are processed by Apple or Google.
        </p>

        <h2>2. Why we process this information</h2>
        <ul>
          <li>To verify purchases and restore subscriptions.</li>
          <li>To activate Premium access on the permitted phone and tablet slots.</li>
          <li>To support device replacement and offline license access.</li>
          <li>To prevent subscription abuse, fraud, and unauthorized access.</li>
          <li>To provide support and comply with legal obligations.</li>
        </ul>
        <p>
          The information is used for app functionality and security. It is not used for
          advertising, cross-app tracking, data brokerage, or behavioral profiling.
        </p>

        <h2>3. Local media and gallery data</h2>
        <p>
          Photos, videos, sessions, selections, local payment/PAC records, reports, and
          print queues are processed locally on your device. If you start a local gallery,
          FTP, hotspot, Wi-Fi, browser sharing, AirPrint, export, or share-sheet workflow,
          the information is transferred only as required by the action you initiate.
        </p>

        <h2>4. Website and support communications</h2>
        <p>
          The website is hosted through a third-party hosting provider, which may process
          standard request information such as IP address, browser type, date, and requested
          page for delivery, security, and operational logging. The contact form opens your
          email application; information is sent only when you choose to send the message.
        </p>

        <h2>5. Service providers and disclosures</h2>
        <p>Information may be processed by:</p>
        <ul>
          <li>Apple App Store and Google Play for purchases and subscription validation.</li>
          <li>Our cloud hosting provider for the licensing service.</li>
          <li>Authorities when disclosure is required by applicable law.</li>
        </ul>
        <p>
        ...
        <p>
          Licensing records are retained while needed to provide, restore, secure, and
          administer the subscription and for any additional period required for fraud
          prevention, dispute handling, or legal compliance. You may request access,
          correction, or deletion by emailing
          <a href="mailto:snapvendinfo@gmail.com">snapvendinfo@gmail.com</a>.
          Some records may need to be retained where required by law or to protect legitimate
          security and fraud-prevention interests.
        </p>

        <h2>7. Security</h2>
        <p>
          The licensing service uses HTTPS in transit and access controls designed to protect
          licensing records. No system is completely secure, but we limit collection to the
          information needed for subscription and device authorization.
        </p>

        <h2>8. Children</h2>
        <p>
          SnapVend Gallery is a professional workflow tool and is not directed to children.
        ...
        <p>
          ...
          required, we use appropriate safeguards and limit processing to the purposes
          described in this policy.
        </p>

        <h2>10. Changes to this policy</h2>
        <p>
          We may update this policy when the application, licensing service, legal
          requirements, or service providers change. The effective date above shows the
          latest revision.
        </p>

        <h2>11. Contact</h2>
        <p>
          Data controller: Metehan Eyicalis / SnapVend Gallery<br>
          Email: <a href="mailto:snapvendinfo@gmail.com">snapvendinfo@gmail.com</a><br>
          Website: <a href="https://snapvendgallery.com">snapvendgallery.com</a>
        </p>

        <div class="privacy-actions">
          <a class="action-link" href="../">Back to SnapVend Gallery</a>
          <a class="action-link action-link-secondary" href="mailto:snapvendinfo@gmail.com?subject=SnapVend%20Privacy%20Request">Privacy request</a>
        </div>
      </article>
    </main>
  </body>
...
def write_privacy_policy_page() -> None:
    output_dir = ROOT / "privacy-policy"
    output_dir.mkdir(parents=True, exist_ok=True)
